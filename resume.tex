...
\section{EXPERIENCE}
   ...
   {\bf Mobile Developer \& Assistant Product Manager}, PTI Insurance Corporation, \\February 2019 - Present\\
   \end{tabbing}\vspace{-20pt} % suppress blank line after tabbing

   \begin{itemize}
	\item Construct elegant and effective mobile code, through self motivation and collaboration with other engineering resources and product team to troubleshoot and make design changes accordingly.
	
	\item Be a project manage role with outsourcing partners: receive requirements, solve disputes and report project timeline to Division Director.
